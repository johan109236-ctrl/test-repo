...
export type PrepChecklistGroup = {
  category: string;
  items: string[]; // "item | sub-note" pipe syntax
};
...
export const prepGuides: Record<string, PrepGuideData> = {
    ...
    sections: [
      {
        ...
        content: {
          cards: [
            { icon: '⛰', title: 'Extreme altitude zone', body: 'All expeditions operate between 5,500m and 6,812m — well into the extreme high-altitude zone where oxygen is severely depleted.' },
            { icon: '🧗', title: 'Technical climbing required', body: 'Fixed ropes, crampons, ice axe, and jumar ascenders are mandatory tools on every expedition summit push.' },
            { icon: '🏕', title: 'High camp system', body: 'All expeditions use a Base Camp plus one or two high tented camps. Acclimatization rotations are built into every itinerary.' },
            { icon: '🩺', title: 'Medical screening required', body: 'A full medical check-up including ECG, blood pressure, and blood oxygen baseline is required at least 8 weeks before departure.' },
            { icon: '🛡', title: 'NMA climbing permit', body: 'All peaks require an official Nepal Mountaineering Association (NMA) climbing permit in addition to standard trekking permits.' },
            { icon: '🚁', title: 'Helicopter evacuation cover', body: 'Insurance must explicitly cover technical mountaineering rescue and helicopter evacuation up to 6,500m. No exceptions.' },
          ],
          checklist: [
            {
              category: 'Pre-departure checklist',
              items: [
                'Full medical check-up including ECG and blood oxygen baseline | At least 8 weeks before departure',
                'NMA peak climbing permit confirmed | Arranged through NHA',
                'Technical mountaineering insurance | Must cover helicopter evacuation to 6,500m',
                'Vaccinations complete | Typhoid, Hepatitis A/B, Tetanus',
                'Diamox (acetazolamide) prescription | Discuss dosage with your GP — 125mg twice daily from day before ascent',
                'Dexamethasone and nifedipine | Emergency HACE/HAPE medications — confirmed with doctor',
                'Mountaineering boots broken in | Minimum 8 full training hikes wearing summit boots',
                'Technical gear acquired and fitted | Harness, crampons, jumar — all tested before arrival',
                'Emergency contacts and itinerary filed | With family and your home country embassy',
              ],
            },
          ],
          risks: [
            { icon: '🫁', title: 'HAPE', description: 'High Altitude Pulmonary Edema — wet cough, pink frothy sputum, bubbling lungs. Immediate descent and nifedipine required.' },
            { icon: '🧠', title: 'HACE', description: 'High Altitude Cerebral Edema — ataxia, confusion, slurred speech. Immediate descent and dexamethasone required.' },
            { icon: '🥶', title: 'Frostbite', description: 'In sub-zero hypoxic conditions blood abandons fingers and toes. Double boots, chemical warmers, and constant toe movement are mandatory.' },
            { icon: '🧊', title: 'Hypothermia on fixed lines', description: 'Standing still at anchor congestion points for 30–60 min in pre-dawn cold drops core temp rapidly. Keep a high-loft down parka at the top of your pack.' },
            { icon: '👁', title: 'Snow blindness', description: 'Glaciers reflect up to 80% of UV radiation. Category 4 polarized glacier glasses with side shields are non-negotiable above Base Camp.' },
            { icon: '💪', title: 'Fixed-line fatigue', description: 'Upper body exhaustion on steep headwalls stalls progress and exposes you to rockfall and cold. Pulling stamina must be trained specifically.' },
          ],
        },
      },
      {
  ...
  // ════════════════════════════════════════════════════════════════════════
  // GUIDE 2 — EVEREST REGION TREKS
  // EBC Trek, Three Passes Trek, Gokyo→EBC, Gokyo Lakes,
  // Gokyo + Renjo La, Everest High Passes + Island Peak (trek)
  // ════════════════════════════════════════════════════════════════════════
  'everest-region': {
    title: 'Nepal Himal Adventures',
